...
import { BattleService } from '../panels/Battle/BattleService'
import Home from '../panels/Home'
import Battle from '../panels/Battle/Battle'
import SingleplayerResults from '../panels/SingleplayerResults/SingleplayerResults'
