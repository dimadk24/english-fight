...
def set_correct_answer_to_question(api_client, question: dict):
    ...
    response = call(api_client, question['id'],
                    {
                        'selected_answer': correct_answer_word.text,
                    })
    return response, correct_answer_word.text
...
def set_incorrect_answer_to_question(api_client, question: dict):
    ...
    return response, correct_answer_word.text, incorrect_answer_word
...
def test_sets_incorrect_selected_question_of_current_user(api_client,
    ...
    (response, correct_answer_word,
     incorrect_answer_word) = set_incorrect_answer_to_question(
        api_client, question_1)
